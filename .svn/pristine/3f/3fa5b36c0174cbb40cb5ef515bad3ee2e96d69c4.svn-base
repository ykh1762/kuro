            ...
            <div class="col-12">
              ...
              <div class="card" style="top:-46px;">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">임시 보관함</h4>
                  <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">전자결재</li>
                    <li class="breadcrumb-item active" aria-current="page">임시 보관함</li>
                  </ol>
                </nav>
              </div>
                </div>
...
<!--                   </h6> -->
                  <div class="table-responsive">
                    <table id="zero_config" class="table table-striped table-bordered text-nowrap">
                      ...
                      <tbody>
							<c:forEach items="${tempstList }" var="tempstList"
								varStatus="i">
								<tr>
									<td>
										<div class="d-flex align-items-center">

											<span class="ms-3 fw-normal">${tempstList.app.appDate }</span>
										</div>
									</td>
									<c:choose>
                            			<c:when test="${tempstList.app.appTitle == '휴가신청서'}">
		                            		<td style=""><a href="/approval/vacIngDetail?appCode=${tempstList.app.appCode }&apfCode=${tempstList.app.apfCode}&empNo=${tempstList.app.empNo}">${tempstList.app.appTitle }</a></td>
                            	
                            			</c:when>
                            			<c:when test="${tempstList.app.appTitle == '채용품의서'}">
		                            		<td style=""><a href="/approval/recIngDetail?appCode=${tempstList.app.appCode }&apfCode=${tempstList.app.apfCode}&empNo=${tempstList.app.empNo}">${tempstList.app.appTitle }</a></td>
                            	
                            			</c:when>
                            		</c:choose>
                            		
									
									<td style=" text-align: center;">${tempstList.app.apfCode }</td>
