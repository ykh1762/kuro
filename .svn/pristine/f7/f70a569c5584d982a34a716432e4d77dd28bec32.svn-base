...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-lg-8 col-xl-9 col-md-9">
			<div class="card" style="overflow-y: auto; height: 680px;">
				<div class="card-body">
					<div class="d-flex no-block align-items-center mb-4">
						...
						<div class="ms-auto">
                          ...
                          "
									...
									<i class="bi-person-bounding-box"></i>주소록 추가</button>
							</div>
						</div>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<table id="file_export"
								...
								<thead>
									<tr style="background-color: #D2E0F5; text-align: center;">
										...
										<th style="color: #000000;">이름</th>
										<th style="color: #000000;">부서</th>
										<th style="color: #000000;">직급</th>
										<th style="color: #000000;">이메일</th>
										<th style="color: #000000;">핸드폰 번호</th>
										<th></th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${contactList }" var="contact" varStatus="i">
										<tr>
											...
											<td style="text-align: center;"><span class="fw-normal">${contact.conName }</span></td>
											<td cstyle="text-align: center;">${contact.conDep }</td>
											<td style="text-align: center;">${contact.conPos }</td>
											<td style="text-align: center;"><span
												class="badge bg-light-success text-success font-weight-medium">${contact.conEmail }</span>
											</td>
											<td style="text-align: center;">${contact.conTel }</td>
											<td style="text-align: center;"><a class="deleteBtn" data-no='${contact.conCode }'>
													<button type="button"
		...
		<div class="col-lg-4 col-xl-3 col-md-3">
			<div class="card">
				...
				<div class="card-body">
					<div class="list-group mt-4" style="border-color: #adabab;">
						<a href="/contact/list" class="list-group-item active"><i
							data-feather="list" class="feather-sm fill-white me-2"></i>공용주소록</a>
						<a href="/contact/list" class="list-group-item contact" style="border: 2px solid #adabab;"><i
							data-feather="users" class="feather-sm fill-white me-2"></i> 전체사원
							주소록 <span class="badge bg-success ms-auto">${contactList.size() }</span>
						</a>
					...
					<div class="list-group" style="border: 2px solid #adabab;">
						...
						<a href="/contact/mnDetail" style="border-color: #adabab;"
							...
							네트워크기술부 </a> <a href="/contact/secDetail" style="border-color: #adabab;"
							class="list-group-item d-flex align-items-center contact"><i
							data-feather="alert-triangle" class="feather-sm fill-white me-2"></i>
							보안기술부 </a> <a href="javascript:void(0)" style="border-color: #adabab;"
							class="list-group-item d-flex align-items-center contact"><i
