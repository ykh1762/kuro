   ...
   <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex no-block align-items-center mb-4">
                    <h4 class="card-title">부서 > 네트워크기술부</h4>
                    <div class="ms-auto">
                      <div class="btn-group">
       	...
       	<table id="file_export" class="table table-bordered nowrap display dataTable no-footer" role="grid" aria-describedby="file_export_info" >
                     <thead>
                        <tr role="row" style="background-color: #D2E0F5;">
                ...
                <div class="card-body" >
                  ...
                  <div class="list-group mt-4">
                    <a href="/contact/list" class="list-group-item active"
                      ><i data-feather="list" class="feather-sm fill-white me-2"></i>공용주소록
                      </a>
                  ...
                  <div class="list-group">
                    ...
                    <a href="/contact/secDetail" class="list-group-item d-flex align-items-center contact"
