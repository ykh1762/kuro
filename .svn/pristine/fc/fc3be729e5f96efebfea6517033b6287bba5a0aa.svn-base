				...
				<div class="accordion accordion-flush" id="accordionFlushExample">
					<div class="accordion-item">
						...
						<div id="flush-collapseOne" class="accordion-collapse collapse show"
							...
							<div class="accordion-body">
								...
								<c:forEach items="${depFolderList }" var="depList">
									<c:if test="${empty depList.folParcode}">
										<p>${depList.folName }</p>
									</c:if>
								</c:forEach>
							</div>
					...
					<div class="accordion-item">
						<h2 class="accordion-header" id="flush-headingTwo">
							...
							aria-expanded="false" aria-controls="flush-collapseTwo" id="empCloud" style="background-color: transparent;">개인 자료실</button>
						</h2>
	...
	<div class="right-part mail-list bg-white" style="overflow-y: auto; overflow-x: hidden;">
		...
		<div class="container-fluid note-has-grid">
			<div class="tab-content" id="tabContent">
				<input type="hidden" id="depCloCode" value="${depFolderList[0].cloCode }">
...
$(function(){
	...
	console.log("확인 : ", ${depFolderList[0].folUse});
	
	<c:forEach items="${depFolderList}" var="list">
				...
				<div class="col-md-4 single-note-item all-category note-important" > 
				 <div class="card card-body">
				 	...
				 	<div style="display:inline">
				 		...
				 		<input type="button" class="btn btn-danger" id="uploadBtn" data-folparcode value="업로드" style="width: 60px; height: 30px">
				 	</div>
				 	<div class="note-content ckbox"> 
