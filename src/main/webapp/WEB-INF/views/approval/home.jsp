                ...
                <table class="table"  style="border-color: #adabab;">
                  <thead>
                    <tr style="">
                      ...
                      <th style="width: 15%; border-top: 1px; border-bottom: 1px; border-style: solid; border-color: rgb(185, 186, 187); text-align: center; background-color: #dddddd;">결재양식코드</th>
                      ...
                      <c:otherwise>
                        <c:forEach items="${appEndList }" var="appEndList" varStatus="i" end="1">
                          <tr>
                            ...
                            <td style=" text-align: center;">${appEndList.app.apfCode }</td>
