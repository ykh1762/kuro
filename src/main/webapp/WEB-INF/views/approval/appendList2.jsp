		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-body">
					...
					<h6 class="card-subtitle lh-base">Home > 전자결재 > 결재 완료 문서</h6>
				</div>
				<div class="table-responsive">
					<table class="table customize-table mb-0 v-middle">
						...
						<tbody>
							<c:forEach items="${appEndList }" var="appEndList"
								varStatus="i">
								<tr>
									<td>
										<div class="d-flex align-items-center">

											<span class="ms-3 fw-normal">${appEndList.appDate }</span>
										</div>
									</td>
									<td>${appEndList.appTitle }</td>
									<td>
